  ...
  // keymap for default
    [_QWERTY] = LAYOUT_universal(
        ...
        KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
                  TT(_MOUSE), KC_LGUI  , KC_LALT  , LOWER    , KC_BSPC  , KC_SPC   , RAISE    , XXXXXXX  , XXXXXXX  , SCRL_MO
    ),

    [_LOWER] = LAYOUT_universal(
        KC_TAB   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     , KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_UNDS  ,
        _______  , XXXXXXX  , RSG(KC_LEFT),KC_LNG2, ESC_ENG  ,TT(_NUMPAD),KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , XXXXXXX  , KC_RCTL  ,
    ...
    [_ADJUST] = LAYOUT_universal(
        ...
        _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  , IME_LOCK , KC_MPLY  , KC_MPRV  , IME_UNLOCK,XXXXXXX  , KC_MNXT  , _______  , _______  ,
                   _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______
    ),

    [_MOUSE] = LAYOUT_universal(
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_TO_CLICKABLE_INC   , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_MY_SCR  ,
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_TO_CLICKABLE_DEC  , KC_MY_BTN1  , KC_MY_BTN1  , KC_MY_BTN2  , XXXXXXX  , XXXXXXX  ,
    ...
    [_NUMPAD] = LAYOUT_universal(
        ...
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,TT(_NUMPAD),XXXXXXX  , KC_P4    , KC_P5    , KC_P6    , KC_PAST  , KC_PSLS  ,
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_P1    , KC_P2    , KC_P3    , KC_PPLS  , KC_PMNS  ,
                   XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_BSPC  , KC_ENT   , KC_P0    , XXXXXXX  , XXXXXXX  , XXXXXXX
    )
};
// clang-format on
