...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_universal(
        ...
        KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
                 TT(_NUMPAD), KC_LGUI  , KC_LALT  , LOWER    , KC_BSPC  , KC_SPC   , RAISE    , XXXXXXX  , XXXXXXX  , KC_MY_SCR
    ),
    ...
    [_MOUSE] = LAYOUT_universal(
        ...
        XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , KC_TO_CLICKABLE_DEC ,KC_MY_BTN1,KC_MY_BTN3,KC_MY_BTN2, XXXXXXX  , KC_SCROLL_DIR_V,
