...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, TT(_MOUSE), KC_LALT, KC_LGUI,  LOWER,  XXXXXXX, KC_SPC,  RAISE,  KC_RGUI, KC_RALT, KC_RCTL, XXXXXXX
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, LOWER, _______, KC_DEL, _______, _______,  _______, _______, _______
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    KC_LSFT, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, IME_LOCK, IME_UNLOCK, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, KC_INS,
