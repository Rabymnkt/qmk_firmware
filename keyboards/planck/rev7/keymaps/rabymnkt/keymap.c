...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    TT(_MOUSE), KC_LALT, KC_LGUI, KC_LNG2,  MO(_LOWER),  XXXXXXX, KC_SPC,  MO(_RAISE), KC_LNG1,  KC_RGUI, KC_RALT, KC_RCTL
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    KC_LSFT, XXXXXXX, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, KC_INS,
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, XXXXXXX ,     KC_P0, KC_PDOT,  KC_ENT, KC_PEQL, KC_NUM
)
};
