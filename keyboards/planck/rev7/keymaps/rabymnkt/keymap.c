...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, TT(_MOUSE), KC_LALT, KC_LGUI, MO(_LOWER), KC_BSPC, KC_SPC, MO(_RAISE), KC_LNG1, KC_LNG2, KC_RCTL, XXXXXXX
),

[_LOWER] = LAYOUT_planck_grid(
     KC_TAB, KC_1,    KC_2,          KC_3,    KC_4,    KC_5,        KC_6,    KC_7,        KC_8,    KC_9,    KC_0,    KC_UNDS,
    KC_LCTL, XXXXXXX, SGUI(KC_LEFT), KC_CAPS, ESC_ENG, TT(_NUMPAD), KC_LEFT, KC_DOWN,     KC_UP,   KC_RGHT, XXXXXXX, KC_RCTL,
    KC_LSFT, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,     KC_HOME, KC_PGDN,     KC_PGUP, KC_END,  KC_RGUI, KC_RALT,
    _______, _______, _______,       _______, _______, _______,     KC_ENT,  MO(_ADJUST), _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, MO(_ADJUST), KC_DEL,  _______, _______, _______, _______, _______, _______
),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_INS,  XXXXXXX, IME_LOCK, KC_LNG2, IME_UNLOCK, KC_MPRV, KC_LNG1, KC_MPLY, KC_MNXT, _______, _______,
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, KC_P4, KC_P5,   KC_P6,  KC_PAST, KC_PSLS,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, TT(_NUMPAD), XXXXXXX, XXXXXXX, KC_P1, KC_P2,   KC_P3,  KC_PPLS, KC_PMNS,
