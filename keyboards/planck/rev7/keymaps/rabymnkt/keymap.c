...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, TT(_MOUSE), KC_LALT, KC_LGUI,  LOWER,  KC_BSPC, KC_SPC,  RAISE,  KC_RGUI, KC_RALT, KC_RCTL, XXXXXXX
),

[_LOWER] = LAYOUT_planck_grid(
     KC_TAB,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_UNDS,
    KC_LCTL, XXXXXXX, SGUI(KC_LEFT), TT(_NUMPAD), ESC_ENG, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, KC_PLUS,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, KC_ESC, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_RGUI, KC_RALT,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    KC_LCTL, XXXXXXX, XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, KC_WBAK, KC_WSCH, KC_WHOM, KC_WFWD, KC_WREF,  KC_PSCR,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, IME_LOCK, IME_UNLOCK, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, KC_INS,
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______ ,     KC_P0, KC_PDOT,  KC_ENT, KC_PEQL, KC_NUM
)
};
